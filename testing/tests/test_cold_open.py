...
account+catalog oracle catches it red. The gate is the oracle RULE (principle 10) over a
frozen grounded but false answer fixture (reviewer finding G5), so an improvement to Atlas
