...
planner that designs novel tasks (and the rich case format it would emit) is deliberately not built
here. Naming the role now keeps the three agent shape honest without preempting that design.
"""
...
class Planner(Protocol):
    """The planner port. Adapters: ``StaticPlanner`` now; a generative planner is a future adapter
