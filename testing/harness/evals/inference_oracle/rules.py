...
plan cost me?" — derivations over several facts plus policy, with no column to read. A flat key-value
oracle cannot grade those without becoming a reasoner.
...
answer whose truth you never pre-stored.
"""
