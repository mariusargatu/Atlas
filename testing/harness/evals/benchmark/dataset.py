...
model versions over a golden set of 100 items is a P5+ effort, and the statistics article's
point is the *reasoning*, which the fixture exercises end to end. The marginals match the
