...
_DEFAULTS = {"ollama": "qwen2.5:7b", "anthropic": "claude-sonnet-5", "openai": "gpt-5.6-sol"}  # 2026-07-10
...
def build_chat_model(provider: str | None = None, model_id: str | None = None) -> BaseChatModel:
    ...
    if provider == "ollama":
        ...
        return ChatOllama(model=model_id, base_url=os.environ.get("OLLAMA_BASE_URL", "http://localhost:11434"))
