...
class TurnState(TypedDict):
    ...
    session: dict  # {customer_id}, non model channel; identity from the session (principle 1)


async def _mcp_call(customer_id: str, tool_name: str, args: dict) -> str:
    """Call an account tool over the in memory MCP transport; return the canonical text."""
