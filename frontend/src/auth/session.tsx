...
/**
 * Session = the identity seam (principle 1). The access token lives in MEMORY (never localStorage, to
 * avoid XSS), the refresh token is an httpOnly cookie the browser sends automatically. `customer_id` is
 * read back from the login response for display only. Every API call derives identity on the server
